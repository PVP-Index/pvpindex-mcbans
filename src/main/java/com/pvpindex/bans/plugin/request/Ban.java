...
public class Ban {
    ...
    private void globalBan() {
        new Thread(() -> {
            ...
            kick(localize("globalBanMessage", I18n.REASON, reason, I18n.SENDER, senderName));
    ...
    private void localBan() {
        new Thread(() -> {
            ...
            kick(localize("localBanMessage", I18n.REASON, reason, I18n.SENDER, senderName));
    ...
    private void tempBan() {
        new Thread(() -> {
            ...
            kick(localize("tempBanMessage", I18n.REASON, reason, I18n.SENDER, senderName));
            ...
            plugin.getServer().getPluginManager()
                    .callEvent(new PlayerTempBanEvent(
